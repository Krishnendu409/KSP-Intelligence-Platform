...
[![Zoho Catalyst](https://img.shields.io/badge/Zoho_Catalyst-Advanced_I/O_Serverless-e42525?style=for-the-badge&logo=zoho&logoColor=white)](https://catalyst.zoho.com)
[![Runtime Node 20](https://img.shields.io/badge/Runtime-Node.js_20_LTS-339933?style=for-the-badge&logo=nodedotjs&logoColor=white)](https://nodejs.org)
[![React 19 & Vite](https://img.shields.io/badge/Frontend-React_19_%2F_Vite_8-61DAFB?style=for-the-badge&logo=react&logoColor=black)](https://vite.dev)
[![Storage Hybrid FTS5](https://img.shields.io/badge/Storage-SQLite_FTS5_%2F_Catalyst_DataStore-003B57?style=for-the-badge&logo=sqlite&logoColor=white)](https://www.sqlite.org)
[![Security Military RBAC](https://img.shields.io/badge/Security-Cryptographic_RBAC_%2F_Audit_Log-4c1?style=for-the-badge&logo=opensecurity&logoColor=white)](#-military-grade-security--jurisdiction-walls)
...
```mermaid
graph TD
    subgraph Client [React 19 / Vite Frontend]
        UI[Command UI & Tactical HUD] --> Store[Zustand State & Snapshot Engine]
        UI --> Map[31-District Karnataka GIS Map]
        UI --> Graph[Cytoscape BFS Network Analyzer]
    end

    subgraph API [Express Gateway / Catalyst Serverless]
        Store -- JSON REST API --> Auth[JWT Cryptographic Auth Middleware]
        Auth --> RBAC[Territorial Scope & RBAC Firewall]
        RBAC --> Audit[Immutable Audit Logger]
        Audit --> Router[API Engine & Copilot Query Analyzer]
    end

    subgraph Adapter [Catalyst Cloud / Edge Adapter]
        Router --> CatAdapter[Catalyst Service Adapter]
        CatAdapter -- Cloud Mode --> CatData[Zoho Catalyst Data Store / Stratus]
        CatAdapter -- Edge Mode --> SQLite[Better-SQLite3 Relational & FTS5 Engine]
        SQLite --> FTS[FTS5 BM25 Virtual Text Index]
    end
```
